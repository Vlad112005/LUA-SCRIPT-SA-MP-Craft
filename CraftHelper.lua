...
function main()
	...
	autoupdate("https://github.com/Vlad112005/LUA-SCRIPT-SA-MP-Craft/blob/master/-version.json", '['..string.upper(thisScript().name)..']: ', "https://vk.com/infernalvlad")
		...
		if imgui.BeginMenuBar() then
			if imgui.BeginMenu(u8'Настройки') then
				 ...
				 if imgui.MenuItem(u8'Информация') then
				 	sampAddChatMessage('[Craft Helper] {FFFFFF}Автор: Владислав Инфернал.', 0xF1CB09)
				 	sampAddChatMessage('[Craft Helper] {FFFFFF}Вк: vk.com/infernalvlad', 0xF1CB09)
				 end
				imgui.EndMenu()
			end
			imgui.EndMenuBar()
